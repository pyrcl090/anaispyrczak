...
project4.addEventListener("click", function(){
    ...
    image4.innerHTML = "<img src='projets/rpt4.png' />";
    image5.innerHTML = "<img src='projets/rpt.png' />";
    image6.innerHTML = "";
...
project5.addEventListener("click", function(){
    ...
    project7.innerHTML ="prints"
    project5.innerHTML = "pain de mie de pain"
    text.innerHTML ="Using bread as an indicator of overconsumption, overproduction, and the overall detriments created on under capitalism.<br><br> In this project / pain de mie de pain / I aim to elaborate using images and notes made on Pyotr Alexeyevich Kropotkin's book La Conquête du Pain. <br><br>project in progress..."
...
project7.addEventListener("click", function(){
    ...
    image.innerHTML = "<img src='./projets/prints.png' />";
    image2.innerHTML = "";
    image3.innerHTML = "";
    image4.innerHTML = "";
    image5.innerHTML = "";
